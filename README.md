...
![Screenshots](readme-source/Screenshot (13).png)


## **Screenshot 2**:


![Screenshots](readme-source/Screenshot 2025-03-20 231143.png)
...
│   ├── number_meanings.json # Special number meanings
│   ├── reddit_cleaned.csv  # Cleaned dataset without NaN or deleted comments
│   ├── reddit_preprocessed.csv # Preprocessed dataset
│   ├── reddit_tokenized.csv # Tokenized and lemmatized dataset
│   ├── train_encoded.csv   # Encoded training data
│   └── test_encoded.csv    # Encoded test data
